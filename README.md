...
<a href="https://www.ulmod.com/magento-2-html-sitemap-extension.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Auto-generate an SEO Optimized HTML sitemap that includes store views, categories pages, products pages, CMS pages, and additional pages;
* Ability to exclude a specific category, product, and CMS pages in the HTML sitemap 
* Ability to configure the sitemap metadata (eg. meta title, description, and keywords)
* Support 2 sitemap layouts: product list moved into categories and product list separated from categories;
* Ability to add additionals or customs links to the HTML sitemap
* Ability to crop/add trailing slash on any URLs in the sitemap;
* Configure the HTML Sitemap in the backend
* Mobile-friendly 
* Support multi-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/umhtmlsitemap-main.png">
